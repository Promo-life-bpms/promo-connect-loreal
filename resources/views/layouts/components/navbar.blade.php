<div  class="fixed top-0 left-0 right-0 z-50">
    ...
    <nav class="w-full flex justify-between py-2 px-4 md:px-12 items-center flex-wrap bg-white shadow-md mb-4" >
        <div class="w-full md:w-1/12 mb-2 md:mb-0">
            <a href="{{ route('index') }}">
                <img src="{{asset('img/logo_loreal.png')}}"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Esta seguro de que desea
                            salir del sitio?</h3>
                        <a class=" bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
                            href="{{ route('logout') }}"
            ...
            <div class="flex flex-col md:flex-row justify-around">
                ...
                @role(['buyers-manager', 'buyer'])
                    <div class="mb-7 md:mt-7 md:mb-0 mx-2">
                        <p class="text-base  font-semibold"><a href="{{ route('compras') }}">MIS COMPRAS</a></p>
                    </div>
                
                    <div class="mb-7 md:mt-7 md:mb-0 mx-2">
                        <p class="text-base  font-semibold"><a href="{{ route('misCotizaciones') }}">MIS COTIZACIONES</a></p>
                    </div>
                    <div class="mb-7 md:mt-7 md:mb-0 mx-2">
                        <p class="text-base  font-semibold"><a href="{{ route('special') }}">ESPECIALES</a></p>
                    </div>
                @endrole
